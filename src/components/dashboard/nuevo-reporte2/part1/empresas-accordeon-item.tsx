...
export default function EmpresasAccordionItem({part1Data, setPart1Data}: {part1Data: Part1DataType, setPart1Data: Dispatch<SetStateAction<Part1DataType>>}) {
    return (
        <AccordionItem
            value="empresa"
...
function EmpresasSuspended({part1Data, setPart1Data}: {part1Data: Part1DataType, setPart1Data: Dispatch<SetStateAction<Part1DataType>>}) {
