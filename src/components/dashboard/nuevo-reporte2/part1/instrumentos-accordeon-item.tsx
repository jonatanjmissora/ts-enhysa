...
export default function InstrumentosAccordionItem({part1Data, setPart1Data}: {part1Data: Part1DataType, setPart1Data: Dispatch<SetStateAction<Part1DataType>>}) {
    return (
        <AccordionItem
            value="instrumento"
        ...
        >
                ...
                <Suspense fallback={<span className="absolute top-2 left-1/2 w-60 px-6 py-2 card bg-background textXS ring ring-foreground/10 dark:ring-foreground/7 justify-end animate-pulse">. . .</span>}>
                    <InstrumentosSuspended part1Data={part1Data} setPart1Data={setPart1Data}/>
                </Suspense>
...
function InstrumentosSuspended({part1Data, setPart1Data}: {part1Data: Part1DataType, setPart1Data: Dispatch<SetStateAction<Part1DataType>>}) {
	...
	const instrumento = instrumentos.find((instrumento) => instrumento.id === actualInstrumentoId)
	useEffect(() => {
		if(instrumento?.id) {
	...
	return (
		<div className="absolute sm:top-2 sm:left-1/2 left-0 top-13 ">
            <Select defaultValue={part1Data.instrumentoId || instrumentos?.[0].id || ""} onValueChange={(value) => setPart1Data(prev => ({...prev, instrumentoId: value}))}>
                <SelectTrigger
                    className="w-60"
