...
export default function InicioTags() {
	return (
		<div className="grid grid-cols-1 sm:grid-cols-3 gap-5 sm:gap-10">
			<div className="p-4 sm:p-4 sm:px-6 2xl:p-10 card bg-accent rounded-lg gap-4 sm:justify-start sm:gap-6 ">
				<FileChartColumn className="size-17 sm:size-16 2xl:size-20 text-blue-600/50 p-3 sm:p-3 2xl:p-4 bg-slate-900/75 rounded-lg shadow-xl" />
			...
			<div className="p-7 sm:p-4 sm:px-6 2xl:p-10 card bg-accent rounded-lg gap-4 sm:justify-start sm:gap-6">
				<CheckCircle2 className="size-17 sm:size-16 2xl:size-20 text-green-500/50 p-3 sm:p-3 2xl:p-4 bg-green-900/75 rounded-lg shadow-xl" />
			...
			<div className="p-7 sm:p-4 sm:px-6 2xl:p-10 card bg-accent rounded-lg gap-4 sm:justify-start sm:gap-6">
				<Clock className="size-17 sm:size-16 2xl:size-20 text-amber-500/50 p-3 sm:p-3 2xl:p-4 bg-amber-900/75 rounded-lg shadow-xl" />
				<div className="flex flex-col gap-2">
