	...
	return (
		<div className="grid grid-cols-3 gap-10">
			<div className="p-10 bg-accent border border-border rounded-xl flex items-center gap-6">
				<FileChartColumn className="size-20 text-foreground/70 p-4 bg-background rounded-lg shadow-xl cursor-pointer" />
			...
			<div className="p-10 bg-accent border border-border rounded-xl flex items-center gap-6">
				<CheckCircle2 className="size-20 text-foreground/70 p-4 bg-background rounded-lg shadow-xl cursor-pointer" />
				<div className="flex flex-col gap-2">
			...
			<div className="p-10 bg-accent border border-border rounded-xl flex items-center gap-6">
				<Clock className="size-20 text-foreground/70 p-4 bg-background rounded-lg shadow-xl cursor-pointer" />
				<div className="flex flex-col gap-2">
