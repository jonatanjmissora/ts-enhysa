	...
	return (
		<div className="flex justify-between items-center flex-col sm:flex-row gap-10 sm:gap-0">
			<div className="flex flex-col gap-4 sm:gap-2">
				<h2 className="text-3xl sm:text-[20px] 2xl:text-2xl text-center textXL sm:text-left dark:text-shadow-lg/50">
					Panel de Control
				</h2>
			...
			<Link
				to="/new-report2"
				className="flex items-center gap-2 sm:text-base 2xl:text-xl tracking-wide p-6 py-4 text-foreground rounded-xl themeBtnAccent  my-shadow w-full sm:w-auto justify-center"
			>
