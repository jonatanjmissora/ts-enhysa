...
export default function MovilNewReport({setPart1Data, part1Data, setPart2Data, part2Data, setPart3Data, part3Data}: {setPart1Data: (data: Part1DataType) => void, part1Data: Part1DataType, setPart2Data: (data: Part2DataType) => void, part2Data: Part2DataType, setPart3Data: (data: Part3DataType) => void, part3Data: Part3DataType}) {
