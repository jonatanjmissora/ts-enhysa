...
function RouteComponent() {
	...
	return (
		<section className="w-screen h-screen flex items-center relative overflow-hidden">
			...
			>
				{/* LEFT */}
				<div className="bg-linear-to-b dark:from-background/80 dark:to-background/70 from-(--gray-300)/80 to-(--gray-100)/70 w-[55dvw] h-[150dvh] absolute -left-40 -bottom-60 -rotate-25 my-shadow"></div>
				<LoginForm setActiveForm={setActiveForm} />

				{/* CENTER */}
				<div className="bg-linear-to-b dark:from-background/80 dark:to-background/70 from-(--gray-300)/80 to-(--gray-100)/70 w-140 h-[200dvh] absolute left-225 -bottom-80 -rotate-25 my-shadow"></div>
				<div className="absolute left-250 top-1/2 translate-y-[-50%] z-10 flex flex-col gap-3 justify-center items-center">
					...
					<h1 className="text-8xl font-bold tracking-widest text-green-700 dark:text-shadow-lg/50">
						EnHySa
					</h1>
					<p className="text-xl italic text-center tracking-wider w-[80%] text-pretty text-foreground/75 dark:text-shadow-lg/50">
						Gestiona tus informes de iluminación y protocolo.
					</p>
				</div>
				{/* RIGHT */}
				<div className="bg-linear-to-b dark:from-background/80 dark:to-background/70 from-(--gray-300)/80 to-(--gray-100)/70 w-[55dvw] h-[150dvh] absolute -right-30 -bottom-30 -rotate-25"></div>
