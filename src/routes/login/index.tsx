		...
		<section className="w-screen h-screen flex items-center relative overflow-hidden">
			...
			>
				...
				<div className="absolute left-250 top-1/2 translate-y-[-50%] z-10 flex flex-col gap-3 justify-center items-center">
					...
					<h1 className="text-8xl font-bold tracking-widest text-green-700 text-shadow-lg/50">
						EnHySa
					</h1>
					<p className="text-xl italic text-center tracking-wider w-[80%] text-pretty text-foreground/75 text-shadow-lg/50">
